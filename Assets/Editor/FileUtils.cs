...
public static class FileUtils
{
	...
	static string otherFolderName = "com.example.other";
	static string utilsFolderName = "com.example.utils";
	static string signFolderName = "com.example.gensignature";

	public static void initAndroidResources(string folderName,Boolean other = true,Boolean sign = true)
	{
		string resPath = "Plugins/Android_work/";
		string destPath = "Plugins/Android/";
		DeleteFolder(destPath);
		//CreateFolder("Plugins/Android/com.example.utils");
		//CreateFolder("Plugins/Android/com.example.other");
		//CreateFolder("Plugins/Android/com.example.gensignature");
	
		CopyFolder(resPath + folderName,destPath);
		CopyFolder(resPath + utilsFolderName,destPath + utilsFolderName);
		if(other) CopyFolder(resPath + otherFolderName,destPath + otherFolderName);
		if(sign) CopyFolder(resPath + signFolderName,destPath + signFolderName);
	}
}
